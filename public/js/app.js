...
function movetoCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('/add-to-cart', pizza).then(function (res) {
...
function removefromCart(deletepizza) {
  axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('/delete-from-cart', deletepizza).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
    new (noty__WEBPACK_IMPORTED_MODULE_0___default())({
      type: 'success',
      timeout: 1000,
...
deleteFromCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var deletepizza = JSON.parse(btn.dataset.pizza);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51MHREESAIB73QxtIup6hOckRTH7hJWD3G6rC1bWvn2QdOkMKzRr8bG3l1ji8RfUEPts6ASsdnt62DbhTtTkFsauD00pu0Wa7qw');
          case 2:
